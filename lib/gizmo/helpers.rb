module Gizmo
  ...
  module Helpers
    ...
    def on_page &block
      ...
      raise NilResponseError, "Doh! response object is nil. This generally means your scenario has not yet visited a page!" unless body
      yield PageObject.new(self, body, current_url)
    end
